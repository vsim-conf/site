jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2017, 9-1, 13, 20, 0, 0)}); // enter event day
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 17,
        center: new google.maps.LatLng(42.643400, 27.677751), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(42.643400, 27.679751) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>UNWE Study and recreational center</b><br/>2 Kraybrezhna Street<br/> Ravda, BULGARIA"  //add your address
    });
