jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2018, 9-1, 11, 20, 30, 0)}); // enter event day
...
$(window).load(function(){
    ...
    infowindow = new google.maps.InfoWindow({
        content: "<b>UNWE Study & Relaxation Center</b><br/>2 Kraybrezhna Street,<br/> Ravda, Bulgaria"  //add your address
    });
